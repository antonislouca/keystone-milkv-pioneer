...
public:
  Verifier(
      ...
      const std::string &eapp_file, const std::string &rt_file,
      const std::string &ld_file, const std::string &sm_bin_file)
      //   : params_(params),
      : eapp_file_(eapp_file), rt_file_(rt_file), ld_file_(ld_file),
...
private:
  ...
  // the Verifier.
  static void verify_hashes(Report &report, const byte *expected_enclave_hash,
